...
const tableStructures = {
	reviews: [
		...
		{ name: 'product_id', type: 'VARCHAR(50)', constraints: 'NOT NULL' },
		{ name: 'user_id', type: 'VARCHAR(50)', constraints: 'NOT NULL' },
		{ name: 'profile_name', type: 'VARCHAR(100)', constraints: '' },
		{ name: 'helpfulness_numerator', type: 'INTEGER', constraints: 'DEFAULT 0' },
		{ name: 'helpfulness_denominator', type: 'INTEGER', constraints: 'DEFAULT 0' },
		{ name: 'score', type: 'INTEGER', constraints: 'NOT NULL' },
		{ name: 'time', type: 'TIMESTAMP', constraints: 'NOT NULL' },
		{ name: 'summary', type: 'VARCHAR(255)', constraints: '' },
...
export const generateTableDDL = (tableName) => {
	...
	const columnDefinitions = tableStructure
		.map((column) => {
